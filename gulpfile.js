...
exports.default = gulp.series(clean, html, gulp.parallel(styles, scripts, fonts, img, files), watch)
exports.build = gulp.series(clean, html, gulp.parallel(styles, scripts, fonts, img, files))